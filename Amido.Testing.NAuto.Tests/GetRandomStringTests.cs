...
namespace Amido.Testing.NAuto.Tests
{
    ...
    public class GetRandomStringTests
    {
        ...
        public void Should_Return_A_Fixed_Length_Random_String_Which_Can_Include_Any_Characters_And_Casing()
        {
            ...
            // Act
            var result1 = NAuto.GetRandomString(length, CharacterSetType.Anything, Casing.Any);
            var result2 = NAuto.GetRandomString(length, CharacterSetType.Anything, Casing.Any);
        ...
        public void Should_Return_A_Random_String_Between_MinLength_And_MaxLength()
        {
            ...
            // Act
            var result1 = NAuto.GetRandomString(minLength, maxLength, CharacterSetType.Anything, Casing.Any);
            var result2 = NAuto.GetRandomString(minLength, maxLength, CharacterSetType.Anything, Casing.Any);
        ...
        public void Should_Return_A_Fixed_Length_Random_String_Which_Can_Contain_Lower_Case_Only()
        {
            ...
            // Act
            var result1 = NAuto.GetRandomString(length, CharacterSetType.Alpha, Casing.Lowered);
            var result2 = NAuto.GetRandomString(length, CharacterSetType.Alpha, Casing.Lowered);
        ...
        public void Should_Return_A_Fixed_Length_Random_String_Which_Can_Contain_Upper_Case_Only()
        {
            ...
            // Act
            var result1 = NAuto.GetRandomString(length, CharacterSetType.Alpha, Casing.Uppered);
            var result2 = NAuto.GetRandomString(length, CharacterSetType.Alpha, Casing.Uppered);
        ...
        public void Should_Return_A_Random_String_Which_Can_Contain_Spaces()
        {
            ...
            // Act
            var result1 = NAuto.GetRandomString(length, CharacterSetType.AlphaNumeric, Casing.Any, Spaces.Any);
            var result2 = NAuto.GetRandomString(length, CharacterSetType.AlphaNumeric, Casing.Any, Spaces.Any);
        ...
        public void Should_Return_A_Random_String_Which_Should_Start_With_A_Space()
        {
            ...
            // Act
            var result1 = NAuto.GetRandomString(length, CharacterSetType.AlphaNumeric, Casing.Any, Spaces.Start);
            var result2 = NAuto.GetRandomString(length, CharacterSetType.AlphaNumeric, Casing.Any, Spaces.Start);
        ...
        public void Should_Return_A_Random_String_Which_Should_End_With_A_Space()
        {
            ...
            // Act
            var result1 = NAuto.GetRandomString(length, CharacterSetType.AlphaNumeric, Casing.Any, Spaces.End);
            var result2 = NAuto.GetRandomString(length, CharacterSetType.AlphaNumeric, Casing.Any, Spaces.End);
        ...
        public void Should_Return_A_Random_String_Which_Should_Start_And_End_With_A_Space()
        {
            ...
            // Act
            var result1 = NAuto.GetRandomString(length, CharacterSetType.AlphaNumeric, Casing.Any, Spaces.StartAndEnd);
            var result2 = NAuto.GetRandomString(length, CharacterSetType.AlphaNumeric, Casing.Any, Spaces.StartAndEnd);
