...
namespace Amido.NAuto.UnitTests.Builders.Services
{
    ...
    public class PopulateNullableIntServiceTests
    {
        ...
        public void SetUp()
        {
            ...
            populateNullableIntService = new PopulateNullableIntService(dataAnnotationConventionMapper.Object);
        ...
        public class Populate : PopulateNullableIntServiceTests
        {
            ...
            public void Should_Return_New_Random_String_Based_On_Auto_Builder_Configuration_When_No_Convention_Exists()
            {
                ...
                result.Value.ShouldBeGreaterThanOrEqualTo(autoBuilderConfiguration.IntMinimum);
                result.Value.ShouldBeLessThanOrEqualTo(autoBuilderConfiguration.IntMaximum);
            }
        }
    }
}
